...
const ShowBook = () => {
  ...
  useEffect(() => {
    setLoading(true);
    axios
      .get(`https://book-list-api-delta.vercel.app/books/${id}`)
      .then((response) => {
  ...
  return (
    <div className='p-4'>
      <BackButton />
      <h1 className='text-3x2 my-4'>Show Book</h1>
      {loading ? (
        <Spinner />
      ) : (
        <div className='flex flex-col border-2 border-sky-400 rounded-md w-fit p-4'>
          <div className='my-4'>
